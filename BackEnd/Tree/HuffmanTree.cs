...
namespace BackEnd.Tree
{
    ...
    public class HuffmanTree
    {
        ...
        public int Height
        {
            get => _height;
            private set =>
                _height = value >= 0 ? value : throw new ArgumentException("The provided height is negative.");
        }
        ...
        public Node Root
        {
            get => _root;
            private set =>
                _root = value ?? throw new ArgumentNullException(nameof(value), "The provided node is null.");
        }
