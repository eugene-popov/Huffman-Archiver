...
namespace BackEnd
{
    ...
    public class BitWriter : IDisposable
    {
        ...
        public BitWriter(Stream outputStream)
        {
            ...
            if (_outputStream.CanWrite == false) throw new ArgumentException();
        ...
        public void Write(int b)
        {
                ...
                /* if the current byte is completely formed */
            {
                ...
                else if (_outputBuffer != null) _outputBuffer.Add((byte) _currentByte);
        ...
        private void Close()
        {
            while (_numBitsFilled != 0) Write(0);
        }
